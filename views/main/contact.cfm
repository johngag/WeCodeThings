...
<div class="main_content_wrapper main_content_wrapper_sidebar">        
    <div class="content_610">
        ...
        <div id="cf_main">
        	<form action="contact.php" method="post" id="contact_form">
                ...
                <div class="input_wrapper">
            		...
            		<input type="text" id="cemail" name="email" class="required email">
                </div>
                <div class="clear"></div>
                <div class="input_wrapper">
                ...
                <div class="input_wrapper">
                    ...
                    <input type="text" class="verification" id="verification" name="verification">
                </div>
        ...
        <div class="location_box">
        	...
        	<h4>Reno location</h4>
            <p>1627 Lander St. Reno, NV<br>Contact: Joel Hill - <a href="#">jiggidyuo@gmail.com</a><br>Office Phone: (775) 240-3959</p>
    ...
    <div class="content_300 sidebar">
        <form method="get" id="searchform" action="#">
        	<div><input class="search_input text" type="text" value="Search..." name="s" id="s" onFocus="if(this.value==this.defaultValue)this.value='';" onBlur="if(this.value=='')this.value=this.defaultValue;"></div>
        	<div><input type="image" src="images/green_grey/search_btn.png" value="Search" class="btn"></div>
        </form>
        <div class="clear"></div>
        <br><br>
        <h3>Recent posts</h3>
        <ul class="blog_sidebar">
            ...
            <li>
            	<a href="#"><img src="images/green_grey/blog/thumb_02.jpg" alt="thumb"></a>
                <a href="#">Lorem ipsum dolor sit amet</a><br>
                <span><a href="#">February 02 2011</a></span>
            </li>
            
            <li>
            	<a href="#"><img src="images/green_grey/blog/thumb_03.jpg" alt="thumb"></a>
                <a href="#">Donec porttitor condimentum volutpat</a><br>
                <span><a href="#">February 02 2011</a></span>
            </li>
            
            <li>
            	<a href="#"><img src="images/green_grey/blog/thumb_04.jpg" alt="thumb"></a>
                <a href="#">Lorem ipsum dolor sit amet, consectetur adipiscing elit</a><br>
                <span><a href="#">February 02 2011</a></span>
            </li>
        </ul>
