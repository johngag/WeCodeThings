...
<div class="header_wrapper">
    <!-- logo -->
    <div id="logo" style="padding-top:15px;"><a href="#buildURL(action='main.default')#"><img src="#variables.framework.base#images/orange/wecode-logo.png" alt="WeCodeThings.com homepage"></a></div>
    <!-- logo -->
