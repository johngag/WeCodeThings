	...
	<div class="main_content_wrapper"> 
        ...
        <div class="content_610">
            <div style="padding-top:10px;" class="float_left">
				<img src="images/orange/server.jpg" style=" background-color: #ccc; -moz-border-radius: 2px; -webkit-border-radius: 2px; border: 1px solid #000; padding: 3px;" height="169" width="162" alt="businessman">
           	</div>
