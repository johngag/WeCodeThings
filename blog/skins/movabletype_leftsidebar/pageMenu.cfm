...
<ul class="module-list">
	<mango:Pages parentPage="#parent#">	
		<mango:Page>
				...
				<mango:PageProperty ifisnotcurrentpage ifIsNotAncestorOfCurrentPage><li class="module-list-item"><a href="<mango:PageProperty link/>"><mango:PageProperty title /></a></mango:PageProperty>
			</li>
		</mango:Page>
</mango:Pages></ul>
</cfif>