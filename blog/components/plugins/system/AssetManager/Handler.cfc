<cfcomponent extends="org.mangoblog.plugins.BasePlugin">
	...
	<cffunction name="init" access="public" output="false" returntype="any">
		...
		<cfargument name="preferences" type="any" required="true" />
			...
			<cfset initSettings(allowedDomains="flickr.com,picasa.com") />
		<cfreturn this/>
			...
			<cfif eventName EQ "assetManager-getThumb">
				...
				<cfif NOT len(local.error)>
					...
					<cftry>
						...
						<cfelse>
							<cfcontent type="image/png" reset="false" />
...
<!--- :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: --->
	<cffunction name="getThumbnail" access="private" output="false" returntype="Any">
		...
		<cfset var name = "#hash(arguments.source)#_#arguments.width#x#arguments.height#_#arguments.resize#.png" />
		...
		<cfif NOT fileexists(local.destination & name)>
			...
			<cfset imageComponent.writeImage(local.destination & name, "png", 90) /> 
		</cfif>
